...
func (c *userClient) FindUser(ctx context.Context, in *FindUserReq, opts ...grpc.CallOption) (*GetUserInfoResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserInfoResp)
...
type UserServer interface {
	...
	FindUser(context.Context, *FindUserReq) (*GetUserInfoResp, error)
...
func (UnimplementedUserServer) FindUser(context.Context, *FindUserReq) (*GetUserInfoResp, error) {
