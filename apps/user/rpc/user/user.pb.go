...
func (x *RegisterReq) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
const file_user_proto_rawDesc = "" +
	...
	"\x06expire\x18\x02 \x01(\x03R\x06expire\"\x81\x01\n" +
	...
	"\fFindUserResp\x12$\n" +
	"\x04user\x18\x01 \x03(\v2\x10.user.UserEntityR\x04user2\xfc\x01\n" +
	"\x04User\x12%\n" +
	...
	"\vGetUserInfo\x12\x14.user.GetUserInfoReq\x1a\x15.user.GetUserInfoResp\x124\n" +
	"\bFindUser\x12\x11.user.FindUserReq\x1a\x15.user.GetUserInfoRespB\bZ\x06./userb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	8, // 11: user.User.FindUser:output_type -> user.GetUserInfoResp
